...
export function SocialMedia() {
    ...
    const msg = `Hi! I'm interested in your products on ${process.env.COMPANY_NAME}`;
    ...
    return <nav className={clsx(containerClasses)}>
        ...
        <Link target='_blank' href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER}?text=${encodeURIComponent(msg)}`} className="flex items-center p-2 rounded-full hover:bg-gray-100">
